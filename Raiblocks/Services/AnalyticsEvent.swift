...
enum AnalyticsEvent: String {
    ...
    case errorDecodingCMCNanoPriceData = "Error decoding CoinMarketCap CellCoin price data"
    case errorGettingCMCBTCPriceData = "Error getting CoinMarketCap BTC price data"
    case errorGettingCMCNanoPriceData = "Error getting CoinMarketCap CellCoin price data"
    ...
    case sendBegan = "Send CellCoin Began"
    case sendFinished = "Send CellCoin Finished"
    case sendMaxAmountUsed = "Send: Max Amount Used"
    case sendWorkUnwrapFailed = "Send VC Send CellCoin Work Unwrap Failed"
    ...
    case errorFormattingNanoStringToDouble = "Error formatting CellCoin Price Pair String to Double"
    case errorInNanoDecodeFunction = "Error in CellCoinPricePair.decode function"
    case unableToGetNanoPrice = "CellCoin Price Pair Error: unable to get price"
